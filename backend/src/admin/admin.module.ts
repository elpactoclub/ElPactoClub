...
@Module({
  imports: [
    TypeOrmModule.forFeature([User, Event, EventAttendee, Vote, UserVote, Raffle, RaffleEntry, Mission, Post, PostComment, Message, StoreBenefit, Project, ClubCreator, Badge, UserBadge]),
    SettingsModule,
    UsersModule,
    NotificationsModule,
    DmModule,
